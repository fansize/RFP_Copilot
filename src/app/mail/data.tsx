...
export const mails = [
  {
    ...
    text: "Acme Corp is in the process of upgrading our computing hardware to support new software implementations and improve our operational efficiencies. We are seeking proposals from trusted suppliers like CodeFellas for the provision of high-quality laptops tailored to our requirements.",
